...
!(async () => {
  ...
  console.log('京喜领88元红包\n' +
      ...
      '助力逻辑：先自己京东账号相互助力，如有剩余助力机会，则助力作者\n' +
      '温馨提示：如提示助力火爆，可尝试寻找京东客服')
  let res = await getAuthorShareCode('ELBbczLjOCiTpJ6Zgm1LyWbsEuEQ4lsBSDE4oJu1nbFt30HhMcf0BoutEhqtzWLz','ELBbczLjOCiTpJ6Zgm1LyQVCfF9lmJMA0WDU7r52FlSaquiSX-Kd_lBugMhEDNS1','ELBbczLjOCiTpJ6Zgm1LyTmQwrRCinNJjC1V0bYZ3SgSY5d6fGhF9m_8b5m6khnZ','ELBbczLjOCiTpJ6Zgm1LyR1vsDpAfqtA-fi7aFnZb0_1joWZCeu0ztPaU54GdCzl')
  if (!res) {
  ...
  let res2 = await getAuthorShareCode('d')
  if (!res2) {
    await $.wait(1000)
    res2 = await getAuthorShareCode('d')
  }
