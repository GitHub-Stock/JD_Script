...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ['jd_45a01ff067cf5', 'jd_5d4c76e468895', 'jd_5cea967a26dbc', 'jd_lbcRsYtbDgNX'];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ['jd_45a01ff067cf5', 'jd_5d4c76e468895', 'jd_5cea967a26dbc', 'jd_lbcRsYtbDgNX'];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ['jd_45a01ff067cf5', 'jd_5d4c76e468895', 'jd_5cea967a26dbc', 'jd_lbcRsYtbDgNX']
    ...
    if (cookiesArr[i]) {
      ...
      if ($.isNode()) {
        if (process.env.JOY_RUN_HELP_MYSELF) {
          ...
          fixPins.push(...run_pins.splice(run_pins.indexOf('jd_45a01ff067cf5'), 1));
          fixPins.push(...run_pins.splice(run_pins.indexOf('jd_45a01ff067cf5'), 1));
